...
@Service
public class EchoBenchmarkServiceImpl implements EchoBenchmarkService {
	...
	@Override
	public void testEcho(final String url, final int parallelThreads, final int callsPerThread) {
