...
@Service
public class ActiveMQTester extends Tester {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	@Autowired
	@Qualifier(ActiveMQApacheCamelConfig.JMS_NAME)
	...
	protected void startTest(final TesterResult result) {
		...
		String url = ActiveMQApacheCamelConfig.JMS_NAME + ":queue:echo?deliveryPersistent=false&replyToDeliveryPersistent=false";
