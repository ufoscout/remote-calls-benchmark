...
import ufo.remote.calls.benchmark.server.jetty.servlet.AsynchServlet;
...
public class JettyServerImpl implements JettyServer {
	...
	private void init() {
		try {
			...
			servletHolder.setServlet(new AsynchServlet());
			webAppContext.addServlet(servletHolder, "/test/echo/*");
